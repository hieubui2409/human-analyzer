...
| 68 framework skills — ORC 17·PSY 16·CRE 10·GRO 8·MAT 4·COM 5·EVL 8 | harness skill list (auto-injected) + `docs/MODULES.md` (grouping + deps) |
| Per-framework skill→trigger→GUIDE routing | `.claude/skills/_framework-shared/references/{orc,psy,cre,gro,mat,com,evl}-operating-guide.md` |
| Directory structure + profile 25-file schema | `docs/rules/01-profile-structure.md` |
| The 16 rules + EVL framework reference | `docs/rules/{01..16}-*.md` · `docs/rules/17-evl-framework.md` |
