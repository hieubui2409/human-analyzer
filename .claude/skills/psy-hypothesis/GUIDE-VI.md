...
**Lần chạy đầu tiên:** `psy:hypothesis --character chien --scenario "Nhân vật C gets Scholarship X scholarship" --depth shallow` — kiểm tra cảm giác nhanh chóng.

**Lặn sâu:** `psy:hypothesis --character hieu --scenario "Nhân vật B's father returns after 10 years" --depth deep` — phân tích phong phú.

**Đa nhân vật:** `psy:hypothesis --character hieu --scenario "Nhân vật A admits he can't mentor Nhân vật C anymore" --multi` — xem tác động xếp tầng.
...
> Kỹ năng: `psy:hypothesis --character hoa --scenario "Nhân vật B loses his job" --depth shallow`
...
> Kỹ năng: `psy:hypothesis --character hieu --scenario "Mentoring Nhân vật C to exam success" --depth deep`
...
> Kỹ năng: `psy:hypothesis --character hoa --scenario "Sworn brother relationship breaks with Nhân vật A" --multi`
