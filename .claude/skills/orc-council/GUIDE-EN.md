...
Some decisions have no single right answer. Is Nhân vật B's avoidance rooted in attachment anxiety or avoidant attachment? Should Nhân vật A's LinkedIn voice be technical or vulnerable? Should Nhân vật C's career go toward grad school or startup? Instead of you flip-flopping, council gathers independent expert opinions and synthesizes. You get clarity.
...
**First council:** `orc:council --question "Is Nhân vật B's core issue avoidance or anxious attachment?" --category psy --character character-b`
...
**Reference later:** Next time you're deciding about Nhân vật B's formulation, check the decision log.

## 4. Use cases (each = a sample conversation)

### Use case: Resolve clinical ambiguity

> You: "Nhân vật B's behavior looks like both avoidance and anxious attachment. I need clarity."
>
...
> You: "Should Nhân vật A's LinkedIn voice be technical or vulnerable? I'm stuck."
>
...
### Use case: Career path decision for Nhân vật C
...
- **Questions must be focused.** Vague questions ("what about Nhân vật B?") produce vague responses. Be specific.
