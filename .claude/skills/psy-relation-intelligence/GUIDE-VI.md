...
**Ghi đè POV:** `psy:relation-intelligence --dyad hoa chien --character hoa` — quan điểm của Nhân vật B về hướng dẫn Nhân vật C.
...
- **Gợi ý nhân vật chính có thể ghi đè được**: Kỹ năng đề xuất Nhân vật A là "chính" (cạnh nhiều hơn), nhưng bạn có thể đặt `--character hoa` để lật quan điểm. Thay đổi giọng nói nào tải trong cre:post-writer.
